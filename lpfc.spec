...
%define kmod_driver_version	12.0.0.5_dup7.6
...
%define kmod_install_path	extra/kmod-redhat-lpfc
...
# Source code patches
Patch0:	0001-scsi-lpfc-do-not-set-queue-page_count-to-0-if-pc_sli.patch
Patch1:	0002-bump-version.patch
...
Name:		kmod-redhat-lpfc
Version:	%{kmod_driver_version}
Release:	%{kmod_rpm_release}%{?dist}
%if "%{kmod_driver_epoch}" != ""
Epoch:		%{kmod_driver_epoch}
%endif
Summary:	lpfc kernel module for Driver Update Program
Group:		System/Kernel
License:	GPLv2
...
%package -n kmod-redhat-lpfc-firmware
Version:	ENTER_FIRMWARE_VERSION
Summary:	lpfc firmware for Driver Update Program
...
Provides:	kernel-modules = %{kmod_kernel_version_dep}.%{_target_cpu}
%endif
%description -n  kmod-redhat-lpfc-firmware
lpfc firmware for Driver Update Program


%files -n kmod-redhat-lpfc-firmware
...
%package -n kmod-redhat-lpfc-devel
Version:	%{kmod_driver_version}
Requires:	kernel >= 3.10.0-957.el7
Requires:	kernel < 3.10.0-958.el7
Summary:	lpfc development files for Driver Update Program

%description -n  kmod-redhat-lpfc-devel
lpfc development files for Driver Update Program


%files -n kmod-redhat-lpfc-devel
%defattr(644,root,root,755)
...
rpm -ql kmod-redhat-lpfc-%{kmod_driver_version}-%{kmod_rpm_release}%{?dist}.$(arch) | \
...
%changelog
* Thu Feb 14 2019 Eugene Syromiatnikov <esyr@redhat.com> 12.0.0.5_dup7.6-1
